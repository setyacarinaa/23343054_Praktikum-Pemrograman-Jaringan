...
async function main() {
    try {
        ...
        /*
        // Contoh menambahkan banyak data pengguna unik sekaligus:
        const dataBaru = [
            { nama: 'Ridho', usia: 22 },
            { nama: 'Hamdani', usia: 25 },
            { nama: 'Putra', usia: 27 },
            { nama: 'Ucup', usia: 35 },
            { nama: 'Mamang', usia: 46 },
            { nama: 'Doho', usia: 24 },
        ...
        // Insert data baru tanpa menghapus data lama
        const hasilInsert = await clPengguna.insertMany(dataBaru);
        console.log('Data baru berhasil dimasukkan:', hasilInsert.insertedCount, 'dokumen');
        */
